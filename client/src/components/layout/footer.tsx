...
export default function Footer() {
  return (
    <footer className="bg-slate-950 py-12 border-t border-slate-700/50">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="text-3xl font-bold gradient-text mb-4">Kairo Digital</div>
            <p className="text-slate-400 mb-6 max-w-md">
              Where Creativity Meets Conversion. Your digital growth partner for meaningful results.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-slate-400 hover:text-primary-kairo transition-colors">
                <Instagram size={24} />
              </a>
              <a href="#" className="text-slate-400 hover:text-primary-kairo transition-colors">
                <Linkedin size={24} />
