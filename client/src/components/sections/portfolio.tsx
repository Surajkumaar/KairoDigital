...
const portfolioItems = [
  {
    ...
    description: "Experimental typography designs showcasing brand personality through letterforms and dynamic visual storytelling.",
  ...
  },
  {
    ...
    description: "Interactive carousel interfaces that enhance user engagement and content discovery through intuitive design patterns.",
  ...
  },
  {
    ...
    description: "Local food brand campaign that increased sales by 200% through authentic storytelling and community-focused marketing.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
            Every project tells a story of transformation. Here's how we've helped brands achieve remarkable growth through strategic creativity.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl overflow-hidden hover:border-slate-600/50 transition-all duration-500 transform group-hover:-translate-y-4">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <div className="flex items-center space-x-1 px-3 py-1 bg-slate-900/80 backdrop-blur-sm border border-slate-600/50 rounded-full">
                        <StatusIcon size={12} className={`${item.status === 'Full Case Study' ? 'text-green-400' : 'text-yellow-400'}`} />
                  ...
                  <div className="p-8">
                    <h3 className="text-xl font-semibold mb-3 text-white group-hover:text-primary-kairo transition-colors duration-300">
                      {item.title}
                    </h3>
                    ...
                    <div className="mb-6">
                      <div className="text-sm text-slate-400 mb-2">Key Result</div>
                      <div className="text-secondary-kairo font-semibold">{item.metrics}</div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <button className="text-primary-kairo hover:text-blue-400 font-medium text-sm transition-colors duration-300">
                        Learn More
                      </button>
        ...
        >
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-6">
              ...
              <span className="gradient-text ml-2">Success Story?</span>
            </h3>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Let's discuss how we can transform your brand's digital presence and drive meaningful growth.
            </p>
