...
const testimonials = [
  ...
  },
  {
    name: "More Reviews",
    company: "Loading...",
    quote: "Authentic client testimonials and case study results will be featured here as we continue growing our portfolio.",
    image: null
  },
  {
    name: "Success Stories",
    company: "Coming Soon",
    quote: "We're excited to share the incredible results and transformations our clients have experienced with our strategies.",
    image: null
  }
];
            ...
            >
              <div className="flex items-center mb-6">
                {testimonial.image ? (
                  ...
                  <div className={`w-12 h-12 ${index === 1 ? 'bg-gradient-to-br from-primary-kairo to-secondary-kairo' : 'bg-gradient-to-br from-secondary-kairo to-primary-kairo'} rounded-full mr-4`}></div>
                )}
              ...
              <div className="flex text-secondary-kairo">
                {[...Array(5)].map((_, i) => (
